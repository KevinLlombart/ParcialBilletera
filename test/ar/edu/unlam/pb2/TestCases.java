...
public class TestCases {
	...
	public void queSePuedaCrearUnaTarjetaDeCredito() throws NumeroDeTarjetaInvalidoException {
		...
		assertEquals(LIMITE_COMPRA_EN_PESOS, ((TarjetaDeCredito) tarjetaDeCredito).getLimiteCompraEnPesos(), 0.01);
		assertEquals(LIMITE_COMPRA_EN_DOLARES, ((TarjetaDeCredito) tarjetaDeCredito).getLimiteCompraEnDolares(), 0.01);
	}
	...
	public void queSePuedaCrearUnaCuentaBancaria() throws CBUInvalidoException {
		...
		assertEquals(ENTIDAD_ESPERADA, ((Cuenta) cuentaBancaria).getEntidadEspado());
		assertEquals(TITULAR_ESPERADO, ((Cuenta) cuentaBancaria).getTitularEsperado());
	}
	...
	public void queSePuedaCrearUnaCuentaVirtual() throws CVUInvalidoException {
		...
		assertEquals(ENTIDAD_ESPERADA, ((Cuenta) cuentaVirtual).getEntidadEspado());
		assertEquals(TITULAR_ESPERADO, ((Cuenta) cuentaVirtual).getTitularEsperado());
	}
	...
	@Test
	public void queSePuedanAgregarConsumidoresALaBilletera() throws NoCoincideTitularException {
		// Preparaci�n
	...
	public void queSePuedanAgregarDistintosMediosDePagoALaBilleteraDeUnConsumidor() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, NoCoincideTitularException{
		...
		mataGalan.agregarMedioDePago(27541231, new TarjetaDeCredito(5423542385612354L, "Luis Gomez", "10/10/2026", 153, 200.0, 200.0));
		mataGalan.agregarMedioDePago(27541231, new CuentaBancaria("01702046600000087865", "Nacion", "Luis Gomez"));
	...
	@Test
	public void queSePuedaPagarConUnaTarjetaDeCredito() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException,
			CVUInvalidoException, ExcedeLimiteDeCompraException, NoCoincideTitularException,
			MedioDePagoInvalidoException, CuitInvalidoException{
		// Preparaci�n 
		Billetera mataGalan = new Billetera("Ank");
		mataGalan.agregarConsumidor(new Consumidor(27541231, "Luis Gomez"));
		...
		// Ejecuci�n	
		Compra codigoQR = ((Compra) mataGalan.generarCodigoQR(30456213545L, 1000.0));
		Boolean resultado = mataGalan.pagar(codigoQR, mataGalan.buscarConsumidor(27541231).getMedioPagador(48332562153254623L));
